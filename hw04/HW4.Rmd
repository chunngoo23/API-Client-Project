...
plot(adjr_rank_sqr,xlab="Car Weight ", ylab="Miles Per Gallon ", pch=19, col = 'red')
points (adjr_without_sqr, col = "blue")
```
...
I would recommend to keep the squared term The adjusted r-squared with squred term is 0.78 which is much higher than the adjusted r-squred without the squared term,  0.66.
```{r}
mean (adjr_rank_sqr)
```
