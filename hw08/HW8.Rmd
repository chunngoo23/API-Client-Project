...
- I had to register a developer account
- create an app
...
library(RCurl)
#token <- fbOAuth(app_id="1198041707047474", 
...
This is a summary of this users' fanpage liking distribution, including 
...
For this specific user, the year that she had liked the most pages. 
...
a <- getUserLikePageYear("/3047739978573522 : Cathy Lai", "10")
b <- getUserLikePageYear("/3047739978573522 : Cathy Lai", "40")
