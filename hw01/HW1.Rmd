...
## 2. Get some data
American Health Care Act Poll is a 15 observations and 7 variables dataframe. The 15 observations are for 15 times pollings for general public's attitude to American Health Care Act. This ahca_poll data was visualized in the original article to support the argument that Republican's current Health Care Act bill has negative net approval ratings, even worse than the net approval ratings of Obamacare in 2010. Original article: https://fivethirtyeight.com/features/why-the-gop-is-so-hell-bent-on-passing-an-unpopular-health-care-bill/
```{r}
head(ahca_polls)
```
...
ahca_polls_kable = kable (ahca_polls_sub_col)
ahca_polls_kable
```
...
You can predict the net approval ratings by the length of polling question 
$$ 0.15 \times survey \ text \ length - 40.18 = net \ approval \ ratings$$
...
print (b +  ggtitle  ('Relationship between poll question length and response attitude') + labs (y  = "Net Approval Ratings  (-100 ~100)",  x  =  "Text Length"))
...
## 7. More Markdown
>  This is going to be a 100-point homework
^[Lai, T.A. (2019).]
