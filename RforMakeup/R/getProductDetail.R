...
#' @param items Defaults to NULL, you could enter a vector of item strings or one item string to specify one specific feature you want to understand. Valid options for 'items=' include 'name', 'product_type', 'brand', 'product_tags', 'price', 'description', 'image',  'product_colors_hexvalues', and 'product_colors_name.'
#' @param ...
